 ...
 */
package com.grottworkshop.gwsvectorsandboxlib;
...
import com.grottworkshop.gwsvectorsandboxlib.content.res.IntSet;
import com.grottworkshop.gwsvectorsandboxlib.content.res.MyResources;

import static com.grottworkshop.gwsvectorsandboxlib.Utils.LOLLIPOP_PLUS;
...
public class MyVector {
     ...
     * <p>{@link VectorDrawable} otherwise.</p>
     *
    ...
    /**
     * Inflates a <vector> drawable, using {@link VectorDrawable} implementation always.
     * @param resources
     * Resources to use for inflation
     * @param resId
     * <vector> drawable resource
     * @return
     * <p>Inflated instance of {@link VectorDrawable}.</p>
     *
    ...
    static class MrResourcesContext extends ContextWrapper {
        private MyResources mMrResources;
        ...
        public Resources getResources() {
            ...
            if (mMrResources == null || mMrResources.oldFor(superResources)) {
                mMrResources = new MyResources(superResources);
            }
            return mMrResources;
        }
    }
